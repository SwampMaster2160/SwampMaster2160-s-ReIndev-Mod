...
public class ModelRaccoonClient extends ModelBase {
	...
	public ModelRaccoonClient() {
		...
		this.raccoonBody.addBox(-2.5F, -5, -21, 5, 10, 5, 0.0F);
	...
	public void setLivingAnimations(EntityLiving entity, float forward, float haltDelta, float deltaTicks) {
		...
		/*if (raccoon.isRaccoonSitting()) {
			...
			this.raccoonSnout.setRotationPoint(0, headPosTamed, -5);
			this.raccoonHeadMain.setRotationPoint(0, headPosTamed, -5);
			this.raccoonRightEar.setRotationPoint(0, headPosTamed, -5);
			this.raccoonLeftEar.setRotationPoint(0, headPosTamed, -5);
			this.raccoonBody.setRotationPoint(0.0F, 0.0F, 0.0F);
			this.raccoonBody.rotateAngleX = (float) (Math.PI / 2);
			this.raccoonBody.rotateAngleY = 0.0F;
			this.raccoonFloofyTail.setRotationPoint(0, 18.0F, 4);
			this.raccoonLeg1.setRotationPoint(-1.5F, 20.0F, 3.5F);
			this.raccoonLeg2.setRotationPoint(1.5F, 20.0F, 3.5F);
			this.raccoonLeg3.setRotationPoint(-1.5F, 20.0F, -3.5F);
			this.raccoonLeg4.setRotationPoint(1.5F, 20.0F, -3.5F);
			this.raccoonLeg1.rotateAngleY = 0.0F;
			this.raccoonLeg2.rotateAngleY = 0.0F;
			this.raccoonLeg3.rotateAngleY = 0.0F;
			this.raccoonLeg4.rotateAngleY = 0.0F;
		...
		//this.raccoonFloofyTail.rotateAngleZ = raccoon.getShakeAngle(deltaTicks, 0);//-0.2F
	...
	public void setRotationAngles(float forward, float haltDelta, float tick, float yaw, float pitch, float unused) {
		...
		this.raccoonFloofyTail.rotateAngleX = tick * 2;
	}
}
