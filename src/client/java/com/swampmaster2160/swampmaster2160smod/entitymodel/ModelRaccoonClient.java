...
public class ModelRaccoonClient extends ModelBase {
	...
	public ModelRaccoonClient() {
		...
		this.raccoonHeadMain.addBox(-3.0F, -3.0F, -3.0F, 8, 6, 6, 0.0F);
		this.raccoonBody = new Piece(40, 0);
		this.raccoonBody.addBox(-4.0F, -7.125F, -3.0F, 6, 11, 6, 0.0F);
		this.raccoonLeg1 = new Piece(0, 18);
		this.raccoonLeg1.addBox(-1.0F, 1.0F, -1.0F, 2, 6, 2, 0.0F);
		this.raccoonLeg2 = new Piece(0, 18);
		this.raccoonLeg2.addBox(-1.0F, 1.0F, -1.0F, 2, 6, 2, 0.0F);
		this.raccoonLeg3 = new Piece(0, 18);
		this.raccoonLeg3.addBox(-1.0F, 1.0F, -1.0F, 2, 6, 2, 0.0F);
		this.raccoonLeg4 = new Piece(0, 18);
		this.raccoonLeg4.addBox(-1.0F, 1.0F, -1.0F, 2, 6, 2, 0.0F);
		this.raccoonFloofyTail = new Piece(46, 18);
		this.raccoonFloofyTail.addBox(-2.0F, -1.0F, -5.0F, 4, 9, 5, 0.0F);
		...
		this.raccoonSnout.addBox(-1.0F, 1.0F, -5.25F, 4, 2, 3, 0.0F);
